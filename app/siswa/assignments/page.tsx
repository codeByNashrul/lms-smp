    ...
    <div className="rounded-2xl min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors flex flex-col p-6 space-y-8">
      <div>
        ...
        <div className="flex justify-between items-center mb-6">
          <div>
            ...
            <p className="text-sm text-gray-600 dark:text-gray-300">
              Lihat tugas yang diberikan guru beserta lampirannya.
            </p>
          </div>
        ...
        {items.length > 0 ? (
            ...
            <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
              <thead className="bg-gray-100 dark:bg-gray-700">
                <tr>
                  ...
                  <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-200 uppercase tracking-wider">Deadline</th>
                ...
                {items.map((x) => (
                  <tr key={x.id} className="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                    ...
                    <td className="px-6 py-4 text-gray-600 dark:text-gray-300 text-sm">
                      {x.due_at ? new Date(x.due_at).toLocaleString("id-ID") : "-"}
                    </td>
          ...
          <p className="text-center text-gray-500 dark:text-gray-400 mt-6">Belum ada tugas.</p>
        )}
      </div>
    </div>
  );
